...
export function AdminDashboard({ 
  ...
  return (
    <Tabs defaultValue="bookings" className="w-full">
      ...
      <TabsContent value="analytics" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
        <AnalyticsTab 
      ...
      <TabsContent value="bookings" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
        <BookingsTab bookings={initialBookings} rooms={initialRooms} customers={initialCustomers} />
      </TabsContent>
       <TabsContent value="rooms" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
        <RoomsTab rooms={initialRooms} />
      </TabsContent>
      <TabsContent value="customers" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
        <CustomersTab customers={initialCustomers} />
      </TabsContent>
      <TabsContent value="items" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
        <MenuItemsTab menuItems={initialMenuItems} categories={initialCategories} />
      </TabsContent>
      <TabsContent value="categories" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
        <CategoriesTab categories={initialCategories} />
      </TabsContent>
      {isOwner && (
        <TabsContent value="workers" className="mt-4 animate-in fade-in slide-in-from-left-2 duration-300">
